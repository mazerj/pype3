function hout=banner(str)
%BANNER Puts a title above all subplots.
%	BANNER('text') adds text to the top of the figure
%	above all subplots (a "super title"). Use this function
%	after all subplot commands.
% 
% origin: SUPTITLE from Drea Thomas 6/15/95 drea@mathworks.com
